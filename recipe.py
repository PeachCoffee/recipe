...
def generate_recipe():
    ...
    print('selected_restrictions:', selected_restrictions)
    ...
    using {', '.join(ingredients)}.

    It's okay to use some additional ingredients.
    ...
    if selected_restrictions:
        prompt += (
            f" The recipe should follow these restrictions: "
